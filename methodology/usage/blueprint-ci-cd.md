...
- Enforce path/layout rules: Intent under `intents/`, definitions under `intents/blueprints/` (or `intents/system/<feature>/blueprints/`), decisions under `intents/decisions/` (or feature decision folders), description files adjacent to code.
